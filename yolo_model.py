...
if __name__ == '__main__':
    ...
    for root, dirs, files in os.walk(ruta_base):
        ...
        carpeta_salida = os.path.join('YOLO/runs', 'resultados_json/keyframes_output', carpeta_relativa)
    ...
    json_global_path = os.path.join('YOLO/runs', 'resultados_json', 'todas_las_detecciones_global.json')
